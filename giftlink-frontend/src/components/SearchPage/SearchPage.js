...
function SearchPage() {
    ...
    // State variables for the search criteria and results
    ...
    const goToDetailsPage = (productId) => {
        // Navigation to the details page of a selected gift
        ...
        <div className="container mt-5">
            <div className="row justify-content-center">
                <div className="col-md-6">
                    ...
                    {/* Search button with onClick event to trigger search */}
